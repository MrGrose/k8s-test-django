...
1. Примените манифесты Service и Deployment:

```bash
kubectl apply -f yc-sirius/edu-roman-grachev/service.yaml
kubectl apply -f yc-sirius/edu-roman-grachev/deployment.yaml
```

2. Проверьте, что поды и сервис запущены и работают:
